...
[ApiController]
public class ObservationController(IObservationService _service) : ControllerBase
{
    [HttpGet("GetAll")]
    ...
    [HttpPost("add")]
    public async Task<IActionResult> Post(CreateObservationDTO model)
    {
    ...
    [HttpPut("Update")]
    public async Task<IActionResult> Update(int id, CreateObservationDTO DTO)
    {
