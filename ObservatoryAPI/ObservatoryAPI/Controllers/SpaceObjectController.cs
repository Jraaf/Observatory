...
[ApiController]
public class SpaceObjectController(ISpaceObjectService _service) : ControllerBase
{
    [HttpGet("GetAll")]
    ...
    [HttpPost("add")]
    public async Task<IActionResult> Post(CreateSpaceObjectDTO model)
    {
    ...
    [HttpPut("Update")]
    public async Task<IActionResult> Update(int id, CreateSpaceObjectDTO DTO)
    {
